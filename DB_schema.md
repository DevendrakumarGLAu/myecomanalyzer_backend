...
| `id` | `int8` | Primary Identity |
| `campaign_id` | `varchar` |  |
| `deduction_duration` | `date` |  Nullable |
| `deduction_date` | `date` |  Nullable |
| `ad_cost` | `numeric` |  |
| `credits` | `numeric` |  |
| `ad_cost_after_adjustment` | `numeric` |  |
| `gst` | `numeric` |  |
